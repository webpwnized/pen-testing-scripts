# Contributing to Pen-Testing-Scripts

We welcome contributions to **Pen-Testing-Scripts**! To ensure a smooth collaboration, please follow the steps outlined below for submitting changes via **feature branches**.

---

## Getting Started
1. **Fork the Repository:**
   - Click the **Fork** button at the top-right corner of the [Pen-Testing-Scripts GitHub repository](https://github.com/webpwnized/pen-testing-scripts).

2. **Clone Your Fork:**
   ```bash
   git clone https://github.com/<your-username>/pen-testing-scripts.git
   cd pen-testing-scripts
   ```

3. **Set the Original Repository as Upstream:**
   - Add the upstream repository to stay in sync with the main project:
   ```bash
   git remote add upstream https://github.com/webpwnized/pen-testing-scripts.git
   ```
...
2. **Open a Pull Request:**
   - Go to the [Pen-Testing-Scripts repository](https://github.com/webpwnized/pen-testing-scripts) and click on **New Pull Request**.
...
Thank you for your contribution! Together, we can make **Pen-Testing-Scripts** even better.
